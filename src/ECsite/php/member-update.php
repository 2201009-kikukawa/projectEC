...
<body>
    ...
    <form action="member-update-completed.php" method="post">
        <div class="contents-container">
            ...
            <div class="input-edit">
                <input type="text" name="register_birthdate" class="form-input" id="postcode" required />
                <button type="button" class="button-edit">編集</button>
            </div>
            ...
            <div class="input-edit">
                <input type="text" name="register_birthdate" class="form-input" id="address" required />
                <button type="button" class="button-edit">編集</button>
            </div>
