...
<div class="footer">
  ...
  <div class="menu">
    <div class="menu-right">
      ...
      <a href="ComingSoon.php" style="display: flex; align-items: center; text-decoration: none; flex-direction: column;">
      ...
      <?php
      if (isset($_SESSION['member'])) {
        echo '<a href="mypage.php" style="display: flex; align-items: center; text-decoration: none; flex-direction: column;">';
        echo '<img src="../image/my.png" alt="検索" style="width: 25px; margin-bottom: 5px;">';
        echo ' マイページ';
        echo '</a>';
      } else {
        echo '<a href="マイページのファイル.php" style="display: flex; align-items: center; text-decoration: none; flex-direction: column;" onclick="showLoginAlert(); return false;">';
        echo '<img src="../image/my.png" alt="検索" style="width: 25px; margin-bottom: 5px;">';
        echo ' マイページ';
        echo '</a>';
      }
